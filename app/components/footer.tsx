    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container-wide">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/rfx-hub" className="text-gray-400 hover:text-primary flex items-center">
                  <ArrowRight className="w-4 h-4 mr-2" /> Post RFP
                </Link>
              </li>
              <li>
                <Link href="/seeker-resources" className="text-gray-400 hover:text-primary flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/privacy" className="text-gray-400 hover:text-primary flex items-center">
                  <ArrowRight className="w-4 h-4 mr-2" /> Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-gray-400 hover:text-primary flex items-center">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} SustainExchange. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
